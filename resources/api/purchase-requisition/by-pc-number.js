GET('purchase-requisition/by-purchase-contract/:number', () => {
    ...
    validate(data, rule, () => {
        var pr =PurchaseRequisition .select('purchase_requisitions.id', 'purchase_requisitions.number', 'business_unit.id as business_unit_id', 'business_unit.location_code as business_unit_code', 'business_unit.description as business_unit_description')
